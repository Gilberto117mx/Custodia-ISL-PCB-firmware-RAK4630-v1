/*
 * ============================================================================
 * ISL v16 Drone Receiver  ·  REFERENCE receiver for the v16 collar
 * (identical to v13/v14/v15 - v16 only enlarges the collar's LoRa backlog, not the
...
void setup() {
  ...
  Serial.println("=== ISL v16 Drone Receiver (reference) - api.ble.uart NUS, name-match, NEW data + per-record ts ===");

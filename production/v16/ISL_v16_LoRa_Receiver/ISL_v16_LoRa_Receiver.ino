/*
 * ISL v16 LoRa Receiver / ACK node  (reference)
 * -----------------------------------------------------------------------------
 * v16 wire format is IDENTICAL to v15 (v16 only enlarges the collar's on-board LoRa
...
void setup() {
  ...
  Serial.println("=== ISL v16 LoRa Receiver (ACK node, shows GPS CELL health) ===");
  int state = sx.begin();

/*
 * ============================================================================
 * ISL v17 Drone Receiver  ·  REFERENCE receiver for the v17 collar
 * (identical to v13/v14/v15/v16 - v17 is only a collar hardware port, not a wire change to the
...
void setup() {
  ...
  Serial.println("=== ISL v17 Drone Receiver (reference) - api.ble.uart NUS, name-match, NEW data + per-record ts ===");

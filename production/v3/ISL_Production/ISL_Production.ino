/*
 * ============================================================================
 * ISL Board (RAK_feather) - PRODUCTION firmware v3  [GPS time-seed + long sleeps]
 * ============================================================================
 *
...
// ============================================================================
constexpr uint32_t GNSS_PERIOD_MIN       = 120;  // idle deep-sleep between cycles (2 h deployment)
...
{
    say("========================================================");
    say("ISL Board - PRODUCTION v3  (GPS time-seed + long sleeps)");
    say("========================================================");
...
void setup()
{
    ...
    delay(300);
    say("ISL Production v3 (GPS time-seed, long sleeps) boot. Heartbeat, then init...");
}

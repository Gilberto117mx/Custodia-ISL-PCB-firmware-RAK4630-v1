/*
 * ============================================================================
 * ISL v14 Drone Receiver  ·  REFERENCE receiver for the v14 collar
...
void setup() {
  ...
  Serial.println("=== ISL v14 Drone Receiver (reference) - api.ble.uart NUS, name-match, NEW data + per-record ts ===");

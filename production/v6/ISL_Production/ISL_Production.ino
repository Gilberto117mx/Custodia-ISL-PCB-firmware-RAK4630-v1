/*
 * ============================================================================
 * ISL Board (RAK_feather) - PRODUCTION firmware v6
 * ============================================================================
...
#define BATT_ADC_PIN        P0_31     // AIN7, 1M/1M divider + C17 (ratio 2.0; cal unaffected)
...
#define FLASH_OFF_UNDELIV   0x0200    // undelivered ring (8 * 24 B)
...
{
    say("========================================================");
    say("ISL Board - PRODUCTION v6  (SV-gated GPS + backoff + fix re-sync + delivery guarantee)");
    say("========================================================");
...
void setup()
{
    ...
    delay(300);
    say("ISL Production v6 boot. Heartbeat, then init...");
}

/*
 * ============================================================================
 * ISL v13 Drone Receiver  ·  REFERENCE receiver for the v13 collar
 * ============================================================================
...
void setup() {
  ...
  Serial.println("=== ISL v13 Drone Receiver (reference) - api.ble.uart NUS, name-match, NEW data + per-record ts ===");
